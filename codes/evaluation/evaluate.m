function evaluate()
  zhx('/home/web_server/zhouhuanxiang/disk/log/results/EDVR_GCB_Vimeo_woTSA_M/Vimeo', '/home/web_server/zhouhuanxiang/disk/vimeo/vimeo_septuplet/sequences', 'blocky')
end

function result = zhx(output_dir, target_dir, task)

...
def main():
    ...
    if stage == 1:
        ...
        model = EDVR_arch.EDVR(64, N_in, 8, 5, 10, predeblur=False, HR_in=True, w_TSA=True)
    ...
    save_folder = '/home/web_server/zhouhuanxiang/disk/log/results/EDVR_{}_{}'.format(data_mode, stage)

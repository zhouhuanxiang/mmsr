...
def main():
    ...
    if dataset == 'vimeo90k':
        ...
        general_image_folder(opt)
    elif dataset == 'KWAIVIDEO':
        opt = {}
        ## GT
        opt['img_folder'] = '/home/web_server/zhouhuanxiang/disk/vdata/HD_UGC_raw'
        opt['lmdb_save_path'] = '/home/web_server/zhouhuanxiang/disk/vdata/HD_UGC.lmdb'
        opt['name'] = 'KWAIVIDEO'
        general_kwai_image_folder(opt)
        ## Artifacting
        for crf in crfs:
            opt['img_folder'] = '/home/web_server/zhouhuanxiang/disk/vdata/HD_UGC_crf'+crf+'_raw'
            opt['lmdb_save_path'] = '/home/web_server/zhouhuanxiang/disk/vdata/HD_UGC_crf'+crf+'.lmdb'
            opt['name'] = 'KWAIVIDEO-crf'+crf
            general_kwai_image_folder(opt)
    elif dataset == 'test':
...
def general_kwai_image_folder(opt):
    ...
    # all_img_list = all_img_list[:1000]
    keys = []

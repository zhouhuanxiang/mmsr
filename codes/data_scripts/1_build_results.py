...
if __name__ == '__main__':
    ...
    for crf, model in zip(crfs, models):
        ...
        img_path = '/home/web_server/zhouhuanxiang/disk/log/results/{}'.format(model)
        ...
        compare_path = '~/zhouhuanxiang/disk/log_prev/log_20190905/EDSR_crf{}_baseline/videos-KWAIVIDEO-crf{}_tmp'.format(crf, crf)
        ...
        vids = [vid.split('/')[-2] for vid in vids] 
        print(vids)
        ...
        for vid in vids:
            ...
            if compare_path:
                cpath = os.path.join(compare_path, vid+'_tmp.mp4')
